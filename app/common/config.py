...
class Config(QConfig):
    ...
    animationEnabled = ConfigItem(
        "MainWindow", "AnimationEnabled", True, BoolValidator()
    )
    ...
    # GitHub settings
    githubToken = ConfigItem("GitHub", "Token", "")
    githubTokenEnabled = ConfigItem("GitHub", "TokenEnabled", False, BoolValidator())
