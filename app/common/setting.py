...
VERSION_URL = "https://api.github.com/repos/Y-ASLant/SuperAppStore/releases/latest"  # GitHub Releases API
...
GITHUB_REPOS_FILE = CONFIG_FOLDER / "github_repos.json"  # GitHub 仓库订阅列表
    ...
    if sys.platform == "win32":
        try:
            ...
            with winreg.OpenKey(
                ...
                download_path = winreg.QueryValueEx(
